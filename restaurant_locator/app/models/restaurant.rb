class Restaurant < ActiveRecord::Base
	...
	validates :r_password, presence: true, length: {minimum: 8, maximum: 12}
	validates :restaurant_name, presence: true, uniqueness: true
	validates :r_contact, presence: true, length: {minimum: 12, maximum: 12}
	...
	validates :r_start_time, presence: true, format: {with: /[0-9][0-9]:[0-9][0-9]/} # brute force format
	validates :r_close_time, presence: true, format: {with: /[0-9][0-9]:[0-9][0-9]/} # brute force format
